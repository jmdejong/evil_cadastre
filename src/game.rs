...
pub struct InitArgs {
	...
	#[structopt(short, long, help="the width and height of the world, measured in number of plots")]
	world_size: Pos
}
...
pub struct UpdateArgs {
	...
	#[structopt(short, long, help="The path to the directory where the game files are relative to the home directory")]
	game_dir: String
}
